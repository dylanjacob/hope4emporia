		...
		function getAdvisories() {
			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function(index, advisory) {
						result += "<tr><td>"+advisory['id']+"</td><td>"+advisory['message']+"</td><td><a href=\"javascript:void(0)\" onclick=\"deleteAdvisory('"+advisory['id']+"')\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-trash-o\"></i></a><a href=\"/a/advisories/"+advisory['id']+"\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-arrow-right\"></i></a><a href=\"/a/advisories/"+advisory['id']+"/edit\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-pencil\"></i></a></td></tr>";
					});
				$('#list').html('');
				$('#list').html(result);
				},
	...
	<div class="col-xs-6 col-xs-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<div class="col-xs-10"><h3 class="panel-title">Advisories</h3></div>
					<div class="col-xs-2">
						<a href="{{ action('AdvisoriesController@create') }}" class="btn btn-default btn-xs"><i class="fa fa-plus"></i></a>
					</div>
				</div>
			</div>
