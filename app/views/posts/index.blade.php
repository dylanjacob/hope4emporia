			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function(index, post) {
						result += "<tr><td>"+post['id']+"</td><td>"+post['title']+"</td><td>"+post['pubdate']+"</td><td><a href=\"javascript:void(0)\" onclick=\"deletePost('"+post['id']+"')\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-trash-o\"></i></a><a href=\"{{ URL::action('PostsController@index') }}/"+post['id']+"\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-arrow-right\"></i></a><a href=\"{{ URL::action('PostsController@index')}}/"+post['id']+"/edit\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-pencil\"></i></a></td></tr>";
					});
				$('#list').html('');
				$('#list').html(result);
				},
	...
	<div class="col-xs-6 col-xs-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<div class="col-xs-10"><h3 class="panel-title">Posts</h3></div>
					<div class="col-xs-2">
						<a href="{{ action('PostsController@create') }}" class="btn btn-default btn-xs"><i class="fa fa-plus"></i></a>
					</div>
				</div>
			</div>
