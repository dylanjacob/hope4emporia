			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-xs-10 col-xs-offset-1">
						{{ Form::open(array('action' => 'AppController@store', 'method' => 'post', 'class' => 'form-horizontal')) }}
						<div class="form-group">
							{{ Form::text('id', '', array('placeholder' => 'Application ID', 'class' => 'form-control')) }}
						</div>
						<div class="form-group">
							{{ Form::text('name', '', array('placeholder' => 'Application Name', 'class' => 'form-control')) }}
						</div>
						<div class="form-group">
							{{ Form::text('secret', Str::random(36), array('id' => 'secret', 'class' => 'form-control', 'readonly' =>''))}}
						</div>
						<div class="form-group">
							<button type="submit" class="btn btn-primary">Add Application</button>
							<button type="button" id="regen-secret" class="btn btn-default">Regenerate Secret</button>
							<a href="{{ URL::action('AppController@index') }}" class="btn btn-default">Cancel</a>
						</div>
						{{ Form::close() }}
					</div>
				</div>
